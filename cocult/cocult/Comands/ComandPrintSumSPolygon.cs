namespace cocult.Comands
{
    ...
    /// </summary>
    class ComandPrintSumSPolygon : IComand,IExample
    {
        /// <summary>
        ...
        public ComandPrintSumSPolygon(  ListFigure<Figure> listEnteredShapes)
        {
        ...
        {
            return $"{NameComand}  - находит сумму площадей всех введенных многоугольников";
        }
    }
}
