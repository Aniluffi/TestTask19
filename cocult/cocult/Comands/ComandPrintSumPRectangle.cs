namespace cocult.Comands
{
    ...
    /// </summary>
    class ComandPrintSumPRectangle : IComand,IExample
    {
        /// <summary>
        ...
        public ComandPrintSumPRectangle(ListFigure<Figure> a)
        {
        ...
        {
            return $"{NameComand}  - находит сумму периметров всех введенных прямоугольников";
        }
    }
}
